                    ...
                    <div className="col-xl-7 corp" >
                        <div className="card">
                            <div className="card-body text-center d-flex flex-column align-items-center">
                                <div className="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-person-plus">
                                ...
                                <form className="postins" method="post" data-bs-theme="light" >
                                    <div className="mb-3">
                                        <div className="row">
                                            <div className="col"><input className="form-control" type="email" name="nom" placeholder="nom" /></div>
                                            <div className="col"><input className="form-control" type="email" name="prenom" placeholder="prenom" /></div>
                                        </div>
                                    </div>
                                    <div className="mb-3"><input className="form-control" type="email" name="pseudo" placeholder="pseudo" /></div>
                                    <div className="mb-3"><input className="form-control" type="password" name="mot_de_passe" placeholder="mots de passe " /></div>
                                    <div className="mb-3">
                                    ...
                                    <p className="text-muted"><input type="checkbox" className="check" />Confirmer le mots de passe</p>
                                    <div className="mb-3">
                                        <button className="btn btn-primary shadow d-block w-100 btnCon" type="submit" >S'inscrire</button>
                                    </div>
                                </form>
                            </div>
                        </div>
